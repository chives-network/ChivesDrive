  ...
  const FolderSelector: React.FC<FolderSelectorProps> = ({ onFolderSelect }) => {
    ...
    const handleFileChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (files && files.length > 0) {
        ...
        setSelectedFolderPath(selectedFolder.webkitRelativePath || selectedFolder.path);
        onFolderSelect(selectedFolderPath!); // Assuming only one folder is selected
      }
    }, [onFolderSelect, selectedFolderPath]);
    ...
    return (
      <>
        ...
        {selectedFolderPath && <p>Selected Folder: {selectedFolderPath}</p>}
      </>
    );
  };
            ...
            <Card>
                ...
                <CardContent>
                    <Grid container spacing={5}>
                        ...
                        <Grid item xs={12}>
                            <Fragment>
                                <FolderSelector onFolderSelect={(folderPath) => {
